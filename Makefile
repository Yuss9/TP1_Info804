...
# Project:  viewer.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile viewer.pro
#############################################################################
...
CXXFLAGS      = --std=c++11 -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk -mmacosx-version-min=13.0 -Wall -Wextra -fPIC $(DEFINES)
...
DISTDIR = /Users/huseyinyurtseven/Documents/MasterCours/InfoGraphique.nosync/TP1_Info804/.tmp/viewer1.0.0
...
EXPORT__QMAKE_STASH_ = /Users/huseyinyurtseven/Documents/MasterCours/InfoGraphique.nosync/TP1_Info804/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/huseyinyurtseven/Documents/MasterCours/InfoGraphique.nosync/TP1_Info804/viewer.pro
...
viewer.app/Contents/MacOS/viewer:  $(OBJECTS)  
	@test -d viewer.app/Contents/MacOS/ || mkdir -p viewer.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: viewer.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/macx.conf \
...
viewer.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.viewer,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.viewer,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},13.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,viewer,g" -e "s,@LIBRARY@,viewer,g" -e "s,\$${EXECUTABLE_NAME},viewer,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app >viewer.app/Contents/Info.plist

all: Makefile \
		viewer.app/Contents/PkgInfo \
		viewer.app/Contents/Resources/empty.lproj \
		viewer.app/Contents/Info.plist viewer.app/Contents/MacOS/viewer
